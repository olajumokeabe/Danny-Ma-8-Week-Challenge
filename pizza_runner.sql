...
Create a CTE to record the number of times each ingredient was used, if extra ingredient, add 2, if excluded ingredient, add 0 no extras or no exclusions, add 1*/
